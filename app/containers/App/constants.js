...
export const SET_ACTIVE_USER = 'app/Header/SET_ACTIVE_USER';
export const GET_ACTIVE_USER = 'app/App/GET_ACTIVE_USER';
export const GET_MANAGERS = 'app/App/GET_MANAGERS';
